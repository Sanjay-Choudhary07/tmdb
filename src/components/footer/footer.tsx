...
import "./footer.css"
import footer_logo from "../../assets/logos/footerlogo.svg"
...
return(
    <div className="footer">
        <div className="footer-nav">
            <div>
            <img className="footer-logo" src={footer_logo} alt="footer_logo"></img>
            <div className="user-button">Hi Sanjay!</div>
            </div>
            <div className="footer-lists">
             ...
             <li className="footer-list-item">Terms of Use</li>
                ...
                <li className="footer-list-item">DMCA Policy</li>
             </div>
            </div>
        </div>
    </div>
